...
Route.group(() => {
  ...
  .prefix('api/auth')
  .middleware(['throttle:2', 'Encryptor']);
...
Route.group(() => {
  ...
  .middleware(['CheckFingerPrint', 'auth', 'CaregiverOrAdmin']);
...
Route.group(() => {
  ...
  .prefix('api/client')
  .middleware(['CheckFingerPrint', 'auth', 'ClientOrAdmin']);
...
Route.group(() => {
  ...
  // Accept Booking by Caregiver
  Route.post('booking/accept', 'Booking/BookingActionController.acceptBooking')
    .validator('Booking/BookingActionByCaregiver');

  // Reject Booking by Caregiver
  Route.post('booking/reject', 'Booking/BookingActionController.rejectBooking')
    .validator('Booking/BookingActionByCaregiver');
})
  .prefix('api')
  .middleware(['BookingActionHandler']);