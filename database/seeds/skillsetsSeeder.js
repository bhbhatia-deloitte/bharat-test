  ...
  static async run() {
    const skills = [
      ...
      { caregiver_type: 1, type: '1', english_title: 'Oral Care' },
      {
        caregiver_type: 1,
        type: '1',
        english_title: 'Measure Blood glucose / Cholestrol / Triglyceride',
        en_explanation:
          "<b> 1. What is it? </b> <br> A form of fat produced in the body. <br><br> <b> 2. Patients: </b> <br> People with heart disease and / or diabetes are often found with high levels of triglyceride. <br><br> <b> 3. Causes: </b> <br> Overweight or obese, lack of exercise, smoking, excessive drinking, and carbohydrate accounts for a very high proportion in diets (60% or above of total calories). <br><br> Source: <a target='_blank' href='http://ehealth.nur.cuhk.edu.hk/CUNursing/cun.do?action=healthInfo'>The Nethersole School of Nursing, Chinese University of Hong Kong (Chinese only)</a>",
        ch_explanation:
          "<b> 1. 甚麼來的? </b> <br> 一種體內製造的脂肪形成。<br><br> <b> 2. 患者： </b> <br> 常見患心臟病和 / 或糖尿病患者。<br><br> <b> 3. 成因： </b> <br> 超重或肥胖、缺乏運動、吸煙、過量飲酒和飲食中的碳水化合物佔十分高的比重 ( 即總卡路里60%或以上 )。<br><br> 來源： <a target='_blank' href='http://ehealth.nur.cuhk.edu.hk/CUNursing/cun.do?action=healthInfo'>香港中文大學那打素護理學院</a>",
      },
      ...
      { caregiver_type: 3, type: '1', english_title: 'Oral Care' },
      {
        caregiver_type: 3,
        type: '1',
        english_title: 'Measure Blood glucose / Cholesterol / Triglyceride',
        en_explanation:
          "<b> 1. What is it? </b> <br> A form of fat produced in the body. <br><br> <b> 2. Patients: </b> <br> People with heart disease and / or diabetes are often found with high levels of triglyceride. <br><br> <b> 3. Causes: </b> <br> Overweight or obese, lack of exercise, smoking, excessive drinking, and carbohydrate accounts for a very high proportion in diets (60% or above of total calories). <br><br> Source: <a target='_blank' href='http://ehealth.nur.cuhk.edu.hk/CUNursing/cun.do?action=healthInfo'>The Nethersole School of Nursing, Chinese University of Hong Kong (Chinese only)</a>",
        ch_explanation:
          "<b> 1. 甚麼來的? </b> <br> 一種體內製造的脂肪形成。<br><br> <b> 2. 患者： </b> <br> 常見患心臟病和 / 或糖尿病患者。<br><br> <b> 3. 成因： </b> <br> 超重或肥胖、缺乏運動、吸煙、過量飲酒和飲食中的碳水化合物佔十分高的比重 ( 即總卡路里60%或以上 )。<br><br> 來源： <a target='_blank' href='http://ehealth.nur.cuhk.edu.hk/CUNursing/cun.do?action=healthInfo'>香港中文大學那打素護理學院</a>",
